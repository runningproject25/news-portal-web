...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $created_at = $_POST['created_at']; // Assume it's already in the correct format
    ...
    if (in_array($fileType, ['png', 'jpg', 'jpeg'])) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $stmt = $conn->prepare("INSERT INTO activity (title, content, created_at, image) VALUES (?, ?, ?, ?)");
            if ($stmt === false) {
...
?>
                ...
                <form action="admin.php?page=insert_activity" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
