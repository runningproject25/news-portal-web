...
<body>
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li class="dropdown"><a href="#" class="text-decoration-none"><span>Tambah Info</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                            <ul>
                                <li><a href="admin.php?page=insert_registration" class="nav-link">Rilis Berita</a></li>
                        ...
                        <li class="dropdown"><a href="#" class="text-decoration-none"><span>Hapus Info</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                            <ul>
                                <li><a href="admin.php?page=delete_registration" class="nav-link">Rilis Berita</a></li>
                        ...
                        <ul>
                            <li><a href="admin.php?page=edit_registration" class="nav-link">Rilis Berita</a></li>
    ...
    <div class="container-xxl mt-5">
        <h2 class="text-center">Data registration</h2>
        
        <!-- Form Pencarian -->
        <div class="row mb-4">
            <div class="col-md-6 mx-auto">
                <form method="GET" action="">
                    <input type="hidden" name="page" value="edit_registration">
        ...
        <div class="table-container">
            ...
            if (!empty($search)) {
                $sql = "SELECT id, title, image, content, created_at FROM regis WHERE title LIKE ? OR content LIKE ?";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>
                                <a href='admin.php?page=edit_registration_process&id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>
                            </td>
                          </tr>";
                }
