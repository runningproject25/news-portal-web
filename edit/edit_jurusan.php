...
<body>
    ...
    <div class="container-xxl mt-5">
        ...
        <div class="row mb-4">
            <div class="col-md-6 mx-auto">
                <form method="GET" action="">
                    <input type="hidden" name="page" value="edit_jurusan">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Cari berdasarkan jurusan atau program studi..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
        ...
        <div class="table-container">
            ...
            if (!empty($search)) {
                $sql = "SELECT id, jurusan, program_studi, akreditasi, daya_tampung FROM jurusan WHERE jurusan LIKE ? OR program_studi LIKE ?";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>
                                <a href='admin.php?page=edit_jurusan_process&id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>
                            </td>
                          </tr>";
                }
